...
__version__ = pkg_resources.get_distribution("Mopidy-Dwebble").version
...
class Extension(ext.Extension):
    ...
    def setup(self, registry):
        ...
        # TODO: Edit or remove entirely
        from .backend import DwebbleBackend
        registry.add("backend", DwebbleBackend)
